...
function ismultiple ($num){
    if($num%3==0){
      ...
      echo "the number isn't multiple of 3";
}
ismultiple(20);
echo "<br>" ;
...
// echo "<br>" ;
function grade(array $values){
$average =arraySummation ($values)/count ($values);
switch ($average){
    case $average >60 and $average <=70:
        echo"D" ;
        break;

        case $average >70 and $average <=80:
            echo"C" ;
            break;
