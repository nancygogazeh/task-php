...
$phones = [
    ...
    [ 
     'name' => 'INFINIX Zero 8',
     'img_url' =>'https://tejarra-media.s3.amazonaws.com/53493/conversions/infinix-Zero-8i-medium.jpg',
    'rate' => '3',
    'brand' => 'Infinix',
    'price' => 'JOD 205.00',
    'is_out_of_stock' => '1'
    ...
    [ 
     ...
     'img_url' =>'https://mobizil.com/wp-content/uploads/2020/10/Apple-iPhone-12-Pro.jpg',
    'rate' => '1',
    'brand' => 'Apple',
    'price' => 'JOD 973.00',
    'is_out_of_stock' => '1'
    ...
    [ 
     ...
     ',
     'img_url' =>'https://mobizil.com/wp-content/uploads/2022/09/Apple-iPhone-14-Pro-Max.jpg',
    'rate' => '0',
    'brand' => 'Iphone',
    'price' => 'JOD 66.00'
    ],
    [ 
     'name' => 'Huawei Mate 20
     ',
     'img_url' =>'https://hatif.net/wp-content/uploads/2018/12/Huawei-P20-Pro-8-600x600.jpg',
...
<div class="card col-4">
  ...
  <div class="card-body">
    <h6 class="card-title"><?php echo $phones[$i]['brand']?></h6>
    <h3><?php echo $phones[$i]['name']?></h3>
...
echo'<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star" viewBox="0 0 16 16">
  <path d="M2.866 14.85c-.078.444.36.791.746.593l4.39-2.256 4.389 2.256c.386.198.824-.149.746-.592l-.83-4.73 3.522-3.356c.33-.314.16-.888-.282-.95l-4.898-.696L8.465.792a.513.513 0 0 0-.927 0L5.354 5.12l-4.898.696c-.441.062-.612.636-.283.95l3.523 3.356-.83 4.73zm4.905-2.767-3.686 1.894.694-3.957a.565.565 0 0 0-.163-.505L1.71 6.745l4.052-.576a.525.525 0 0 0 .393-.288L8 2.223l1.847 3.658a.525.525 0 0 0 .393.288l4.052.575-2.906 2.77a.565.565 0 0 0-.163.506l.694 3.957-3.686-1.894a.503.503 0 0 0-.461 0z"/>
     ...
     ?>
    <hr>
    <h4 style="color:orange;"><?php echo $phones[$i]['price']?></h4>
<button type="button" class="btn btn-dark">Buy Now</button>
<svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor"   margin-left: 30px; class="bi bi-cart3" viewBox="0 0 16 16">
